...
export type UserMeal = { meal_id: number, user_id: number, name: string, actual_calories?: number, actual_proteins?: number, actual_fats?: number, actual_carbs?: number, actual_portion_grams?: number, meal_time: MealTime, created_at: string, source_type: SourceType };
export type UserIngredient = { ingredient_id: number, user_id: number, name: string, created_at: string, source_type: SourceType, quantity_available_grams: number };
