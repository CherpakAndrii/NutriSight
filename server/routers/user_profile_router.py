...
from utils.auth_utils import validate_req_auth, hash_password
...
def delete_my_profile(deleted_user_id: int, request: Request):
    user_id, error_code = validate_req_auth(request)
    if user_id is not None and user_id == deleted_user_id:
        with Session() as session:
...
async def change_name(request: Request, data: ChangeNameData):
    user_id, error_code = validate_req_auth(request)
    if user_id is not None:
        with Session() as session:
            user_profile = session.get(User, user_id)
...
async def change_age(request: Request, data: ChangeAgeData):
    user_id, error_code = validate_req_auth(request)
    if user_id is not None:
        with Session() as session:
            user_profile = session.get(User, user_id)
...
async def change_sex(request: Request, data: ChangeSexData):
    user_id, error_code = validate_req_auth(request)
    if user_id is not None:
        with Session() as session:
            user_profile = session.get(User, user_id)
...
async def change_diet_type(request: Request, data: ChangeDietTypeData):
    user_id, error_code = validate_req_auth(request)
    if user_id is not None:
        with Session() as session:
            user_profile = session.get(User, user_id)
...
async def change_weight(request: Request, data: ChangeNumericFieldData):
    user_id, error_code = validate_req_auth(request)
    if user_id is not None:
        with Session() as session:
            user_profile = session.get(User, user_id)
...
async def change_height(request: Request, data: ChangeNumericFieldData):
    user_id, error_code = validate_req_auth(request)
    if user_id is not None:
        with Session() as session:
            user_profile = session.get(User, user_id)
...
async def change_goal_calories(request: Request, data: ChangeNumericFieldData):
    user_id, error_code = validate_req_auth(request)
    if user_id is not None:
        with Session() as session:
            user_profile = session.get(User, user_id)
...
async def change_goal_protein(request: Request, data: ChangeNumericFieldData):
    user_id, error_code = validate_req_auth(request)
    if user_id is not None:
        with Session() as session:
            user_profile = session.get(User, user_id)
...
async def change_goal_fat(request: Request, data: ChangeNumericFieldData):
    user_id, error_code = validate_req_auth(request)
    if user_id is not None:
        with Session() as session:
            user_profile = session.get(User, user_id)
...
async def change_goal_carbs(request: Request, data: ChangeNumericFieldData):
    user_id, error_code = validate_req_auth(request)
    if user_id is not None:
        with Session() as session:
            user_profile = session.get(User, user_id)
